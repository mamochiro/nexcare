...
<div class="container" style="padding-top: 5px">
	...
	<div class="tab-content">
		<div id="rule" class="container tab-pane active"><br>
			  ...
			  <li>อัพโหลดภาพลูก 1 ภาพ เลือกเฟรมภาพ แคปชั่นใต้ภาพ และสติกเกอร์ตกแต่ง <span style="font-size: 21px">(1 Account สมัครได้ไม่จำกัด แต่นับเป็น 1 สิทธิ์)</span></li>
		...
		<div id="prize" class="container tab-pane fade"><br>
			  ...
			  <li>ของรางวัลพิเศษจาก <b>3M Nexcare<sup>tm</sup> 500 รางวัล</b></li>
			</ul>
			<br>
		</div>
	</div>
